...
function Item({ product, onSelect }) {
  ...
  return (
    <div className=" bg-gray-300 max-w-sm rounded overflow-hidden shadow-lg mt-16 mb-10 mx-16 ">
      <img className=" w-full h-[300px]" src={product.img} alt={product.name} />
      <div className="px-6 py-4">
        <div className="text-zinc-600 font-bold text-xl mb-2">{product.name}</div>
        <p className="text-gray-700 font-semibold text-base">{product.category}</p>
